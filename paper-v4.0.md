...
The Harmonic Paradigm (V1.0–V3.0, DOIs 10.5281/zenodo.21499052, 10.5281/zenodo.21499190, 10.5281/zenodo.21499251, 10.5281/zenodo.21499507) proposed that eight physically unrelated bosonic systems — from superconducting transmon qubits to quantum gravity — share a universal renormalization-group β-function governing deviations from exact harmonic-oscillator behavior. Version 3.0 [@qnfo-harmonic-v3] retracted the central logistic β-function ansatz $\beta(\alpha) = B\cdot\alpha(1-\alpha)$ after direct calculation showed it incompatible with the known, textbook 1-loop QED β-function $\beta_{\text{QED}}(\alpha) = \frac{2}{3\pi}\alpha^2 + O(\alpha^3)$: the logistic ansatz is linear at leading order near the infrared fixed point, while real QED is quadratic — a difference in universality class, not just a numerical mismatch.
...
The standard textbook result for the 1-loop QED β-function [@peskinschroeder1995, Eq. 12.62] is:
...
|:---|:---|:---|:---|
| β-function structural class near IR | Linear: $\beta \propto \alpha$ | Quadratic: $\beta \propto \alpha^2$ | Quadratic ✓ |
...
| V2.1 | 2026-07 | 10.5281/zenodo.21499251 | Tautology replaced with logistic β-function ansatz; CAL-05 fabricated |
